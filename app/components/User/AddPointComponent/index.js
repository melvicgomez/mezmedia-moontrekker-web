...
function AddPointComponent({ visibility, onCancel, userId }) {
  ...
  return (
    <div>
      <Popup centered visible={visibility} onCancel={onCancel} footer={null}>
        <TextInputComponent
          type="number"
          title="MoonTrekker Point Amount"
          defaultValue={mpAmount}
          value={mpAmount}
          placeholder="Enter MoonTrekker Point Amount"
          onChange={value => {
            setMpAmount(value);
          }}
        />
...
AddPointComponent.propTypes = {};

export default memo(AddPointComponent);
